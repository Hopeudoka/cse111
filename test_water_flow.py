from water_flow import water_column_height, pressure_gain_from_water_height, \
    ...
    pressure_loss_from_pipe_reduction, convert_kilopascal_to_pounds_per_square_inch
...
def test_convert_kilopascal_to_pounds_per_square_inch():
    assert convert_kilopascal_to_pounds_per_square_inch(0.0) == approx(0.0, abs=0.001)
    assert convert_kilopascal_to_pounds_per_square_inch(-12.3) == approx(-1.78396371, abs=0.001)
    assert convert_kilopascal_to_pounds_per_square_inch(112.6) == approx(16.33124502, abs=0.001)
    assert convert_kilopascal_to_pounds_per_square_inch(43) == approx(6.2366211, abs=0.001)
